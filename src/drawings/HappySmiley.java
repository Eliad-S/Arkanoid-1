...
/**
 * The type Happy smiley.
 */
public class HappySmiley implements Sprite {
     ...
     * @param size   the size
     */
    public HappySmiley(Point center, int size) {
        this.center = center;
        this.size = size;
    }
     ...
     * @param size the size
     */
    public HappySmiley(int x, int y, int size) {
        this.size = size;
    ...
    public void drawOn(DrawSurface d) {
        ...
        d.setColor(Color.YELLOW);
        d.fillOval(getX() - 45, getY() + 24, 100, 30);
    }
